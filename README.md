...
### Firecracker VM Proof of Concept

This repository also includes a proof of concept for setting up Firecracker VMs with container support. See the [`firecracker-poc/`](./firecracker-poc/) directory for:

- Scripts to quickly create and manage Firecracker VMs
- Custom kernel building with container support
- Ubuntu 24.04 VM setup with SSH access
...
For more information, see [`firecracker-poc/README.md`](./firecracker-poc/README.md).
